...
task_name="yelp_review"
dataset="--cnndm_dataset_name cnndm --glue_dataset_name yelp_review"
...
python src/train.py --task_name $task_name $dataset $batch_size --num_workers 8 --root_dir $root_dir --ckpt_dir $ckpt_dir --student_mutual_lr $student_mutual_lr --student_distill_lr $student_distill_lr\
        ...
        --cuda --gpu $gpu --do_adversary_teacher --do_adversary_1 --do_adversary_3 --do_cluster --supervised_size 200 --unsupervised_size 5000 --distill_mode 1
